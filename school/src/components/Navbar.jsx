    ...
    <header className='top-0 left-0 w-full h-20 z-40 bg-white shadow'>
      <div className='max-w-screen-2xl mx-auto px-5 flex items-center justify-between h-full'>
        <div className='flex items-center gap-5'>
          <a href='/'>
            <img src='/logo.svg' className="w-[50px]" alt='School Hub' />
          </a>
        ...
        <div className='flex items-center gap-6'>
          <form className='flex items-center bg-[#395F8B1A] rounded-lg px-3 w-[263px] h-[50px]'>
            <img src='/search.svg' alt='search' className="w-[25px]" />
            <input
              type='text'
              placeholder='Buscar'
          ...
          <button type="button" className='flex items-center justify-center bg-[#395F8B1A] rounded-lg px-3 w-[50px] h-[50px]'>
            <span className='material-symbols-rounded text-zinc-950'>
              notifications
            </span>
          </button>
          <button type="button">
          <img src='/icon-avatar-aluno.png' className="w-[50px]" alt='Avatar' />
          </button>
        </div>
      </div>
    </header>
