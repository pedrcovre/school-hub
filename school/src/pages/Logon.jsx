  ...
  const [visibility, setVisibility] = useState({})
    ...
    return (
        <div className="m-[30px] flex min-h-screen select-none">
            ...
            <div className="ml-[160px] mt-[30px] w-1/2">
                <div className="flex flex-col items-center mt-[100px] w-full">
                    <h1 className="text-[40px] font-medium">Crie uma conta</h1>
                    <p className="text-[13px] whitespace-nowrap">Bem-vindo, preencha as informações</p>
                </div>                
                <div className="flex flex-col items-center mt-10">
                    <div className="w-[450px]">
                        <p className="mb-2 text-left font-medium">Matrícula</p>
                        <input
                            type="email"
                    ...
                    <div className="w-[450px]">
                        ...
                        <a className="text-[14px] text-[#395f8b73] mb-[35px] inline-block cursor-pointer">Esqueceu sua senha?</a>
                    </div>
                    <div className="w-[450px]">
                        <button
                            type="submit"
                    ...
                    <div className="text-[15px] mt-2">
                        Já tem uma conta?{" "}
                        <a className="text-[#395f8b] font-medium cursor-pointer">Acesse sua conta</a>
                    </div>
                    <footer className="text-sm mt-26 text-center w-[450px]">
